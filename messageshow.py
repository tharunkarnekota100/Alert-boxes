...
def show_msg():
    # below three stmts return 'ok' when we click on X of messagebox [or] click on 'ok' of messagebox

    # messagebox.showinfo('this is a message box','Telugu Computer World')
    # messagebox.showwarning('this is a message box', 'Telugu Computer World')
