...
def show_msg():
    #ask stmts show two options in display with diffternt return values

    #res = messagebox.askyesno('this is a message box', 'Telugu Computer World')
    #res = messagebox.askquestion('this is a message box', 'Telugu Computer World')
    res = messagebox.askokcancel('this is a message box', 'Telugu Computer World')
